...
# Authenticate GCP using st.secrets (Required for Vertex AI on Cloud)
if "gcp_service_account" in st.secrets:
    # Create a temporary JSON file for GCP to read
...
st.sidebar.header("⚙️ Vertex AI Configuration")
project_id = st.sidebar.text_input("GCP Project ID", help="Your Google Cloud Project ID")
location = st.sidebar.text_input("GCP Location", value="us-central1", help="e.g., us-central1")
